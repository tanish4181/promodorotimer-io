...
class ModernPomodoroOptions {
  ...
  initializeElements() {
    ...
    this.elements.youtubeSubSettings = document.getElementById("youtube-sub-settings");
  ...
  bindEventListeners() {
    ...
    if (this.elements.hideDistractions) {
      this.elements.hideDistractions.addEventListener("change", () => this.updateYouTubeToggleStates());
    }
  }
  ...
  updateYouTubeToggleStates() {
    if (!this.elements.hideDistractions || !this.elements.youtubeSubSettings) return;
    
    const isEnabled = this.elements.hideDistractions.checked;
    this.elements.youtubeSubSettings.disabled = !isEnabled;
  }
